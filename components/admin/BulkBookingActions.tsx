...
export function BulkBookingActions({ rows }: { rows: Row[] }) {
  ...
  async function apply(status: BookingStatus) {
    ...
    setMessage(`Updated ${body.updated} bookings to ${status}.`);
    setSelected({});
    router.refresh();
  }
  ...
  return (
    <div className="rounded-lg border border-slate-200 p-4">
      ...
      <div className="mt-3 max-h-40 space-y-1 overflow-auto rounded bg-slate-50 p-2 text-xs">
